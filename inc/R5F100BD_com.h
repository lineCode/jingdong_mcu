...
#define PR_MSG_COMM_RESET           0x07    /*  */
#define PR_MSG_COMM_BOOTSWAP        0x08    /*  */
...
/*  */
#define PR_TBLED1_INIT()    P1.5 = 1, PM1.5 = 0
                                        /*  */
#define PR_TBLED1_ON()      P1.5 = 0    /*  */
#define PR_TBLED1_OFF()     P1.5 = 1    /*  */

#define PR_TBLED2_INIT()    P1.6 = 1, PM1.6 = 0
                                        /*  */
#define PR_TBLED2_ON()      P1.6 = 0    /*  */
#define PR_TBLED2_OFF()     P1.6 = 1    /*  */
...
/*  */
#define PR_UART0_INIT()     P1.1 = 0, PM1.1 = 1,\
                            P1.2 = 1, PM1.2 = 0
                                        /*  */
/************/
/*  */
